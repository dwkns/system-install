...
echo $CYAN"Transmission.app :$RESET Use ~/Documents/Torrents to store incomplete downloads"
...
#--------------------------- sort the ones below ---------------------------
  ...
  # #echo $CYAN"0x08000100:0" > ~/.CFUserTextEncoding
  ...
  # done
  # echo $CYAN"Done. Note that some of these changes require a logout/restart to take effect."