...
TIME_MACHINE_EXCLUSION_LIST=("/Applications/" "/Library/" "/System/" "/bin/" "/cores/" "/opt/" "/private/" "/sbin/"  "/.vol" "/.fseventsd" "$HOME/Downloads/" "$HOME/Library/Caches/"  "$HOME/Documents/Torrents/" "$HOME/Dropbox/" "$HOME/Library/Application Support/Google/")

BREW_PACKAGES=( "wget" "git" "python" "dockutil" "postgresql" "node") 
...
if $DEBUG; then 
  CASKS_PACKAGES=("iterm2-nightly" "sublime-text3" "things")
  ADD_TO_DOCK=("iterm2-nightly" "things" "sublime-text3")
  BREW_PACKAGES=( "python" "dockutil" "postgresql" "node") 
