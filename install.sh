...
download_and_run scripts/clean.sh
download_and_run scripts/homebrew.sh
#download_and_run scripts/postgres.sh
download_and_run scripts/casks.sh
download_and_run scripts/node.sh
download_and_run scripts/krep.sh
download_and_run scripts/dotfiles.sh
download_and_run scripts/system-settings.sh

download_and_run scripts/sublime.sh
download_and_run scripts/rvm-ruby.sh
download_and_run scripts/gems.sh
